...
void systick_init()
{
	SysTick->LOAD = 1599999; // C o n fi g u r e l o a d v al u e
...
void init_LED(){
	...
	GPIOF->DIR |= 0x8 ; // s e t GREEN pin a s a d i g i t a l output pin
	GPIOF->DEN |= 0x8 ; // Enable PF2 pin a s a d i g i t a l pin
